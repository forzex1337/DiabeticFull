...
CREATE TABLE IF NOT EXISTS `AspNetUsers` (
    ...
    `DiabetesType` longtext CHARACTER SET utf8mb4 NOT NULL,
    `DateOfBirth` datetime(6) NULL,
    `Gender` longtext CHARACTER SET utf8mb4 NULL,
    `Height` decimal(65,30) NULL,
    `Weight` decimal(65,30) NULL,
    `DiagnosisDate` datetime(6) NULL,
    `HbA1cTarget` decimal(65,30) NULL,
    `InsulinType` longtext CHARACTER SET utf8mb4 NULL,
